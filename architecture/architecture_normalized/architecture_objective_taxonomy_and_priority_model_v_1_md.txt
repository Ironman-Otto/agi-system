...
1. **Priority Tier (coarse)** – establishes override dominance.
2. **Weight (fine)** – orders objectives within a tier.
...
- **Dormant** – known objective type but not active
- **Candidate** – triggered but not yet accepted
- **Active** – currently guiding selection
- **Satisfied** – met; no longer guiding selection
- **Escalated** – requires human approval or higher-level intervention
...
- Safety objective activates templates: “Is it dangerous?”, “Where is it?”, “How immediate?”
- Quality objective activates templates: “Is it complete?”, “Is it correct?”, “What is missing?”
