...
1. **Objective Priority** – higher tier objectives dominate
2. **Relevance** – match between context and template tags
3. **Expected Information Gain** – higher gain favored
4. **Expected Cost** – lower cost favored when time/cost constrained
5. **Risk Sensitivity** – safety/policy templates rise under risk
6. **Historical Utility** – templates that worked before are favored
