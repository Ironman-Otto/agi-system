# Architecture – Executive Message Contracts (v1)
...
- A direct mapping from architecture → code interfaces
...
- **episode_id** – execution episode identifier
- **source_module** – module emitting the message
- **target_module** – intended recipient (often AEM)
- **message_type** – semantic message category
