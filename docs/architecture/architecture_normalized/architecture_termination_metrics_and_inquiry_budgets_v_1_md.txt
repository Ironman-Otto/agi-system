...
- How does the system decide that it has learned “enough”?
...
- **Question Count Budget** – maximum number of questions per episode
- **Time Budget** – wall-clock or CPU time
- **Cost Budget** – monetary or resource cost
- **Risk Budget** – tolerated uncertainty or hazard exposure
...
- **Proceed** – sufficient information to continue execution
- **Clarification Required** – missing critical information
- **Escalate** – requires human input or higher authority
- **Abort** – unsafe or prohibited to proceed
